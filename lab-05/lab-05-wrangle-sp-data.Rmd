...
```
```{r fig.margin = TRUE, echo = FALSE, fig.alt = "___"}
# INSTRUCTOR TODO: replace "___" above with an accurate one-sentence description
# of what this photo actually shows (screen-reader text) before publishing.
...
<img src="img/dennys-laquinta-sketches/dennys-laquinta-sketches.001.png" width="300px" height="300px" alt="Sketch showing 3 Denny's location markers and 2 La Quinta location markers scattered on a simple map, not yet connected to each other.">
...
<img src="img/dennys-laquinta-sketches/dennys-laquinta-sketches.002.png" width="300px" height="150px" alt="Sketch showing the first Denny's location connected by two lines to both La Quinta locations, illustrating the two distances that need to be calculated from a single Denny's.">

**Step 3:** Now let's consider all Denny's locations.

<img src="img/dennys-laquinta-sketches/dennys-laquinta-sketches.003.png" width="300px" height="450px" alt="Sketch showing all three Denny's locations, each connected by a line to both La Quinta locations, illustrating all six distance pairings that need to be calculated.">
...
```{r visualize-ak-distances, eval = FALSE, fig.alt = "___"}
# Remember to change eval=FALSE to eval=TRUE!
...
```{r nc-analysis, eval = FALSE, fig.alt = "___"}
# Remember to change eval=FALSE to eval=TRUE!
# Remember to fill in fig.alt above with a short description of what your plot shows!
...
```{r tx-analysis, eval = FALSE, fig.alt = "___"}
# Remember to change eval=FALSE to eval=TRUE!
# Remember to fill in fig.alt above with a short description of what your plot shows!
...
```{r your-state-analysis, eval = FALSE, fig.alt = "___"}
# Remember to change eval=FALSE to eval=TRUE!
# Remember to fill in fig.alt above with a short description of what your plot shows!
# Your code here - adapt from Exercise 9
```
