...
```{r echo=FALSE, fig.fullwidth = TRUE, fig.alt="A cluttered original chart from the AAUP report showing instructional staff employment trends by faculty type from 1975 to 2011, with unclear labels and hard-to-distinguish lines."}
...
**Calculation:** _____ faculty types × _____ years = _____ rows
...
```{r tidyr-gif, echo=FALSE, out.width="80%", fig.alt="Animated diagram illustrating how pivot_longer() reshapes columns of a wide data frame into rows of a long data frame, and how pivot_wider() reverses the process."}
...
```{r plot-staff-first-attempt, fig.width = 10, fig.fullwidth = TRUE, fig.alt="Line plot of instructional staff percentage by year, with lines colored by faculty type but not grouped, producing a warning and a jumbled plot."}
staff_long %>%
...
```{r plot-staff-with-group, fig.width = 10, fig.fullwidth = TRUE, fig.alt="Line plot of instructional staff percentage by year, with one connected, correctly colored line per faculty type."}
staff_long %>%
  ggplot(aes(x = year, 
             y = value, 
...
```{r improved-staff-plot, fig.width = 10, fig.fullwidth = TRUE, eval = FALSE, fig.alt="Improved line plot of instructional staff percentage by year and faculty type, with a descriptive title and clear axis and legend labels."}
...
```{r storytelling-plot, fig.width = 10, fig.fullwidth = TRUE, eval = FALSE, fig.alt="Redesigned line plot emphasizing the rise of part-time faculty relative to other instructional staff types over time."}
# Remember to change eval=FALSE to eval=TRUE!
...
```{r echo=FALSE, fig.fullwidth = TRUE, fig.alt="A cluttered original bar chart of 2016 fisheries production by country, with overlapping labels, an unordered category axis, and an ineffective color scheme."}
...
**Your improved visualization:**
```{r improved-fisheries-plot, fig.width = 8, fig.height = 10, eval = FALSE, fig.alt="Redesigned horizontal bar chart of fisheries production by country, ordered by total tonnage with clear labels and a colorblind-friendly palette."}
# Remember to change eval=FALSE to eval=TRUE!
# Your code here
```
