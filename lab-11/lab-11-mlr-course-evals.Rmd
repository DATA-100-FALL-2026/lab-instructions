...
-   ✅ Understand single predictor regression (Lab 10, Exercises 4-8)
-   ✅ Understand the concepts of R² and adjusted R² (Lab 10, Exercise 6)
...
🧶 ✅ ⬆️ **Knit, commit with message "Updated author name", and push your changes.**
...
The intercept represents _______________________________________________________

**Interpret the slope for bty_avg:**

Holding gender constant, for every one unit increase in beauty rating, _______

**Interpret the slope for gendermale:**

Holding beauty rating constant, male professors are expected to score ________
...
Approximately _____% of the variability in professor evaluation scores is explained by beauty rating and gender.
...
**The coefficient is:** _____ (positive/negative)
...
The relationship between beauty and evaluation score ____________________ (does / does not) vary between male and female professors because __________
...
**score_bty_fit adjusted R²:** _____ (from Exercise 2)

**score_bty_gen_fit adjusted R²:** _____ (from Exercise 3)

**Difference:** _____

**Interpretation:**

The adjusted R² increased/decreased by _____ when we added gender to the model. This tells us that gender ______
...
**Slope of bty_avg in score_bty_fit:** _____ (from Exercise 2)

**Slope of bty_avg in score_bty_gen_fit:** _____ (from Exercise 3)

**Has it changed?**

The slope has changed/not changed. The difference is _____.

**Why might this happen?**

**Hint:** If beauty and gender are related (e.g., if male and female professors have different average beauty ratings), adding gender can change the bty_avg coefficient. Statisticians call this **confounding** (or, when it involves the relationship among predictors themselves, **multicollinearity**) — a predictor's estimated effect shifts because it's correlated with another predictor in the model, not because the underlying relationship actually changed.
...
For teaching faculty with a beauty rating of 0, the expected evaluation score is _____.

**Interpret the slope for bty_avg:**

Holding rank constant, for every one unit increase in beauty rating, ________

**Interpret the slope for ranktenuretrack:**

Holding beauty rating constant, tenure track faculty are expected to score ____

**Interpret the slope for ranktenured:**

Holding beauty rating constant, tenured faculty are expected to score ________

**Adjusted R² for this model:** _____

**How does this compare to score_bty_gen_fit?** _______________________________________________________

**Putting it all together:** Rank all three models you've fit in this lab — `score_bty_fit`, `score_bty_gen_fit`, and `score_bty_rank_fit` — by adjusted R², from best to worst.

**Ranking (best to worst adjusted R²):** _____________________________________________

**Which model would you recommend using, and why?** Consider not just adjusted R², but also interpretability — is the model with the highest adjusted R² necessarily the most useful one to explain to someone unfamiliar with the data?
